...
extern int  hb_compMainExtModule( int argc, const char * const argv[], HB_BYTE ** pBufPtr, HB_SIZE * pnSize, const char * szModuleName, const char * szSource, int iStartLine, void * cargo, PHB_PP_OPEN_FUNC pOpenFunc, PHB_PP_MSG_FUNC pMsgFunc, HB_COMP_FINISH_FUNC pFinishFunc, void * pFinishCargo );
